      ...
      <div className="flex flex-col lgl:flex-row gap-16">
        ...
        >
          <p>
            ...
            strong foundation in <span className="text-textGreen">software development and machine learning.</span> My
            interest in machine learning has grown as I’ve explored how
            ...
            the field. Recently, I’ve also been exploring <span className="text-textGreen">quantum computing</span>,
            combining my curiosity for emerging technologies with my background
            in AI and software engineering. I’m excited to continue learning,
            building, and contributing to projects that blend innovation with
            practicality.
          </p>
          <br />
        ...
        <div className="w-full lgl:w-1/3 h-80 relative group">
          ...
          <div className="absolute w-full h-80 -left-6 -top-6 rounded-lg z-10">
            <Image
              className="rounded-lg h-full object-cover bg-white sm:h-[350px] sm:w-[350px] lg:h-[320px] lg:w-[320px] "
